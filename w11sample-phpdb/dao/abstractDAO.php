...
//errors instead of printing them to the screen.
...
class abstractDAO {
    ...
    /* Database username */
    protected static $DB_USERNAME = "christine";
    /* Database password */
    protected static $DB_PASSWORD = "woaifumu_666";
    /* Name of database */
    ...
    public function getMysqli(){
        return $this->mysqli; //return mysqli object
